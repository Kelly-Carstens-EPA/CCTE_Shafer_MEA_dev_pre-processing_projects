...
load.spikedata_final <- function(pseudoSamplingRate,fileName){
  ...
  # added the following 2 lines Mar 26, 2020 to work with changes in chem.info.3 in h5 file
  ...
  # DIV is not saved in the h5 file. Instead, we get it from the h5 file name

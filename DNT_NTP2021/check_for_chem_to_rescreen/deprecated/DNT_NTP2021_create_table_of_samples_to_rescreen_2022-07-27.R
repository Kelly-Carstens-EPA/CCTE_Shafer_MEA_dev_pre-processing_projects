...
load('DNT_NTP2021/check_for_chem_to_rescreen/data/DNT_NTP2021_tcplfit2_exploratory_ac50_estimates_2022-07-27.RData')
# cat(description)
...
plot.spids <- c(sample.info.tb[num_ac50_below_minconc_and_hit > 0 | num_noisy_endpoints >= 5, spid],
                ...
                'Bisphenol A')
pdf(file = 'DNT_NTP2021/check_for_chem_to_rescreen/figs/DNT_NTP2021_tcplfit2_select_treatments_2022-07-27.pdf',
    width = 8, height = 10)
...
saveWorkbook(wb, file = 'DNT_NTP2021/check_for_chem_to_rescreen/DNT_NTP2021_MEA_NFA_rescreen_recommendations_2022-07-28.xlsx',
             overwrite = T)

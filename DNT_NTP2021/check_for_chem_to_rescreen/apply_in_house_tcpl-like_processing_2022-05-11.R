...
#
# May 11 2022 - just updating with updated preliminary longfile
# ------------------------------------------------------------------------ #
...
# -0.068  -0.004   0.021   0.025   0.056   0.132   11100
...
setkey(dat2, NULL)
save(dat2, description, file = file.path('DNT_NTP2021','check_for_chem_to_rescreen','DNT_NTP2021_preliminary_in_house_normalized_values_2022-05-11.RData'))

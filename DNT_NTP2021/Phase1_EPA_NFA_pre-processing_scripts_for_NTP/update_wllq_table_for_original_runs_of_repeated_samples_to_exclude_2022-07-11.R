...
rescreen.tb <- as.data.table(read.xlsx('DNT_NTP2021_MEA_NFA_rescreen_recommendations_2022-05-26.xlsx', sheet = 2)) # (FOLDER PATH REDACTED)
...
# Looking at the dose-response curves (see DNT_NTP2021\check_for_chem_to_rescreen\figs)

...
# Load mc3-like data
load('DNT_NTP2021/check_for_chem_to_rescreen/data/DNT_NTP2021_preliminary_in_house_normalized_values_2022-08-01.RData')
cat(description)
...
# 2022-08-01 22:13:14 CCTE_Shafer_MEA_dev_AB_dn complete
# 2022-08-01 22:14:06 CCTE_Shafer_MEA_dev_LDH_dn complete
# 2022-08-01 22:14:56 CCTE_Shafer_MEA_dev_active_electrodes_number_up complete
# 2022-08-01 22:15:50 CCTE_Shafer_MEA_dev_burst_duration_mean_up complete
# 2022-08-01 22:21:31 CCTE_Shafer_MEA_dev_burst_rate_up complete
# 2022-08-01 22:27:42 CCTE_Shafer_MEA_dev_bursting_electrodes_number_up complete
# 2022-08-01 22:34:09 CCTE_Shafer_MEA_dev_correlation_coefficient_mean_up complete
# 2022-08-01 22:36:14 CCTE_Shafer_MEA_dev_firing_rate_mean_up complete
# Error in uniroot(acgnlsobj, c(toploc, 1e+05), y = y, tp = tp, ga = ga,  : 
#                    f() values at end points not of opposite sign
# In addition: Warning message:
#   package ‘tcplfit2’ was built under R version 4.1.3 
# 2022-08-01 22:36:39 CCTE_Shafer_MEA_dev_inter_network_spike_interval_mean_up complete
# 2022-08-01 22:37:02 CCTE_Shafer_MEA_dev_interburst_interval_mean_up complete
# 2022-08-01 22:37:26 CCTE_Shafer_MEA_dev_mutual_information_norm_up complete
# Error in uniroot(acgnlsobj, c(toploc, 1e+05), y = y, tp = tp, ga = ga,  : 
#                    f() values at end points not of opposite sign
# 2022-08-01 22:37:49 CCTE_Shafer_MEA_dev_network_spike_duration_std_up complete
# 2022-08-01 22:38:19 CCTE_Shafer_MEA_dev_network_spike_number_up complete
# 2022-08-01 22:39:02 CCTE_Shafer_MEA_dev_network_spike_peak_up complete
# Error in uniroot(acgnlsobj, c(toploc, 1e+05), y = y, tp = tp, ga = ga,  : 
#                    f() values at end points not of opposite sign
# Error in uniroot(acgnlsobj, c(toploc, 1e+05), y = y, tp = tp, ga = ga,  : 
#                    f() values at end points not of opposite sign
# 2022-08-01 22:39:38 CCTE_Shafer_MEA_dev_per_burst_interspike_interval_up complete
# 2022-08-01 22:40:14 CCTE_Shafer_MEA_dev_per_burst_spike_percent_up complete
# 2022-08-01 22:40:41 CCTE_Shafer_MEA_dev_per_network_spike_spike_number_mean_up complete
# 2022-08-01 22:41:08 CCTE_Shafer_MEA_dev_per_network_spike_spike_percent_up complete
# 2022-08-01 22:41:30 CCTE_Shafer_MEA_dev_spike_duration_mean_up complete
...
save(mc4.list, mc5, description, file = file.path('DNT_NTP2021/check_for_chem_to_rescreen/data/DNT_NTP2021_tcplfit2_exploratory_ac50_estimates_2022-08-01.RData'))

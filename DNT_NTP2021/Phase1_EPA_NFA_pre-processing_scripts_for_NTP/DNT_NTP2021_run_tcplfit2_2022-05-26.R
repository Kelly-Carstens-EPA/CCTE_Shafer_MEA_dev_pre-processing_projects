...
# 2022-05-26 15:24:18 CCTE_Shafer_MEA_dev_AB_dn complete
# 2022-05-26 15:24:43 CCTE_Shafer_MEA_dev_LDH_dn complete
# 2022-05-26 15:25:12 CCTE_Shafer_MEA_dev_active_electrodes_number_up complete
# 2022-05-26 15:25:39 CCTE_Shafer_MEA_dev_burst_duration_mean_up complete
# 2022-05-26 15:26:11 CCTE_Shafer_MEA_dev_burst_rate_up complete
# 2022-05-26 15:26:33 CCTE_Shafer_MEA_dev_bursting_electrodes_number_up complete
# 2022-05-26 15:26:58 CCTE_Shafer_MEA_dev_correlation_coefficient_mean_up complete
# 2022-05-26 15:27:24 CCTE_Shafer_MEA_dev_firing_rate_mean_up complete
# Error in uniroot(acgnlsobj, c(toploc, 1e+05), y = y, tp = tp, ga = ga,  : 
# f() values at end points not of opposite sign
# 2022-05-26 15:27:53 CCTE_Shafer_MEA_dev_inter_network_spike_interval_mean_up complete
# 2022-05-26 15:28:20 CCTE_Shafer_MEA_dev_interburst_interval_mean_up complete
# 2022-05-26 15:28:42 CCTE_Shafer_MEA_dev_mutual_information_norm_up complete
# Error in uniroot(acgnlsobj, c(toploc, 1e+05), y = y, tp = tp, ga = ga,  : 
# f() values at end points not of opposite sign
# 2022-05-26 15:29:04 CCTE_Shafer_MEA_dev_network_spike_duration_std_up complete
# 2022-05-26 15:29:27 CCTE_Shafer_MEA_dev_network_spike_number_up complete
# 2022-05-26 15:29:50 CCTE_Shafer_MEA_dev_network_spike_peak_up complete
# Error in uniroot(acgnlsobj, c(toploc, 1e+05), y = y, tp = tp, ga = ga,  : 
# f() values at end points not of opposite sign
# 2022-05-26 15:30:12 CCTE_Shafer_MEA_dev_per_burst_interspike_interval_up complete
# 2022-05-26 15:30:33 CCTE_Shafer_MEA_dev_per_burst_spike_percent_up complete
# 2022-05-26 15:30:55 CCTE_Shafer_MEA_dev_per_network_spike_spike_number_mean_up complete
# 2022-05-26 15:31:19 CCTE_Shafer_MEA_dev_per_network_spike_spike_percent_up complete
# 2022-05-26 15:31:40 CCTE_Shafer_MEA_dev_spike_duration_mean_up complete
length(mc4.list) # 2204
nrow(use.dat) # 2204
...
save(mc4.list, mc5, description, file = file.path('DNT_NTP2021/check_for_chem_to_rescreen/data/DNT_NTP2021_tcplfit2_exploratory_ac50_estimates_2022-05-26.RData'))

...
project.dir <- "" # project main folder (where will look for README files) (FOLDER PATH REDACTED
scripts.dir <- "functions" # update to the folder where the scripts are located (MODIFIED TO FIT ORGANIZATION OF SHARED SCRIPTS FOLDER)
root_output_dir <- getwd() # where the dataset_title folder will be created

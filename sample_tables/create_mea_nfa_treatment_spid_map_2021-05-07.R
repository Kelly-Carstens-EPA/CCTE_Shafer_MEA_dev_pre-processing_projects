# 5/7/2021
# Making a file to describe which samples tested where in each dataset, dates tested
# for the lvl0 released on 2021-05-05
# 
# Background:
...
# (i considered including the treatment_srcf col (added in PFAS2019 data), but that really only applies to renaming treatment in control wells, 
# which is not what we are concerned about)
rm(mea_nfa_lvl0)
...
trt_table[is.na(spidmap_file)] #emtpy, good
